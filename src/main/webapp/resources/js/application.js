var app = (function() {
	...
	var onCreate = function() {
		setContentView();
		 $.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyDmPCXXMQxNDjMHsC9AT66JGelMu5XDh4E&signed_in=true&libraries=places&async=2&callback=initAutocomplete', function() {
		...
		$('#h_logo').click(function(){		
			location.href = app.context() + '/home'
		});
...
var u_header = (function() {
	...
	var onCreate = function() {
		setContentView();
		$('#pub_header').on('click','#m_edit',function(){
			$('#pub_article').html(EDIT);});
