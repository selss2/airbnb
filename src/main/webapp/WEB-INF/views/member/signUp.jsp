...
<div class="control-group space-top-3 space-1">
  ...
  <div class="tooltip tooltip-bottom-middle signup-login-form__tooltip"
       role="tooltip"
       aria-hidden="true"
       data-trigger="#birthday-signup-form-question-trigger"
       data-position="top">
...
<input checked="checked" id="user_profile_info_receive_promotional_email"
       name="user_profile_info[receive_promotional_email]" type="checkbox" value="1">
</label>
<label for="user_profile_info_receive_promotional_email" class="checkbox">
 에어비앤비와 파트너사에 대한 쿠폰, 프로모션, 설문조사, 업데이트를 이메일로 받고 싶습니다.
</label>
  ...
  <div>
    <small>
      회원 가입하면 에어비앤비의 <a href="/terms?source=tos" target="_blank">서비스 약관</a>, <a href="/terms/nondiscrimination_policy?source=tos" target="_blank">비차별 정책</a>, <a href="/terms/payments_terms?source=tos" target="_blank">결제 서비스 약관</a>, <a href="/terms/privacy_policy?source=tos" target="_blank">개인정보 보호정책</a>, <a href="/terms/guest_refund_policy?source=tos" target="_blank">게스트 환불 정책</a>, <a href="/terms/host_guarantee?source=tos" target="_blank">호스트 보호 프로그램 이용약관</a>에 동의하는 것입니다.
    </small>
  </div>
</div>
...
<div class="panel-body js-login-footer signup-login-form__extra-panel-body">
  <div class="clearfix">
    <span class="signup-login-form__switch-copy">
        <a href="/login?" class="modal-link link-to-login-in-signup" data-modal-href="/login_modal?" data-modal-type="login">
          이미 에어비앤비 계정이 있나요?
</a>    </span>
      <a href="/login?" class="modal-link link-to-login-in-signup btn btn-default signup-login-form__btn-rausch-border signup-login-form__btn-font-normal signup-login-form__switch-button" data-modal-href="/login_modal?" data-modal-type="login">
        로그인
</a>  </div>
</div>
